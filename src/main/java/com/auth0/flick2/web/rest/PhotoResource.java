...
import com.auth0.flick2.domain.Photo;
import com.auth0.flick2.repository.PhotoRepository;
import com.auth0.flick2.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.auth0.flick2.domain.Photo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
