...
describe('Photo e2e test', () => {
  ...
  describe('new Photo page', () => {
    ...
    it('should create an instance of Photo', () => {
      ...
      cy.get(`[data-cy="taken"]`).type('2021-11-25T10:06').should('have.value', '2021-11-25T10:06');

      cy.get(`[data-cy="uploaded"]`).type('2021-11-25T08:42').should('have.value', '2021-11-25T08:42');
